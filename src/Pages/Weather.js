...
const Weather = () => {
    ...
    if (Object.values(weatherData).length !== 0) {
        ...
        return (
            <section className="p-6 grid grid-cols-1 sm:grid-cols-8 xl:grid-cols-10 xl:grid-rows-2 gap-5 [&>*]:rounded-xl">
                ...
                <div className="sm:col-span-5 bg-base-content/5 p-6">
