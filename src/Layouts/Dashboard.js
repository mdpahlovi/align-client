                ...
                <div className="sticky top-0 h-16 flex items-center justify-end space-x-4 px-6 2xl:container bg-base-content/5">
                    ...
                    <div className="flex space-x-4">
                        <div
                            className={`transition duration-300 ${
                                showSearchBar ? "opacity-0 -translate-y-full" : "opacity-100 translate-y-16"
                            } md:translate-y-0 md:opacity-100`}
                        >
                            <div className="relative flex items-center focus-within:text-primary text-xl">
                                <FaSearchLocation className="absolute w-max h-max left-4 flex  items-center border-r border-base-content/50 pr-3" />
                                <input
                                    type="search"
                                    name="search"
                    ...
                    <div className="text-right">
                        <Menu as="div" className="relative inline-block text-left">
                            ...
                            >
                                <Menu.Items className="absolute right-0 mt-3 origin-top-right rounded-xl bg-base-content/5 shadow-lg">
                    ...
                    {/* Search Icon */}
                    <button className="icon-button flex justify-center items-center text-lg md:hidden" onClick={() => setShowSearchBar(!showSearchBar)}>
                        <FaSearchLocation />
                    </button>
                    {/* {Toggle Sidebar} */}
